...
declare type TippyProps = React.ComponentProps<typeof Tippy>;
...
declare type Props = TippyProps & AbstractTooltipProps;
export declare const AbstractTooltip: React.FC<Props>;
export {};
