...
declare type Props = Pick<React.ComponentProps<typeof AbstractTooltip>, "children" | "content" | "disabled"> & AbstractTooltipProps;
/**
 * Display a non-interactive tooltip after an element is clicked on and then
 * remove the tooltip after a short period of time
 */
export declare const ConfirmationTooltip: React.FC<Props>;
export {};
